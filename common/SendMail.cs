    ...
    public class SendMail
    {
        public async void SendInvMail(byte[] fileBytes, string EmailId, string InvoiceName,string contactno)
        {
            ...
            using (var clonedMemoryStream = new MemoryStream(fileB.ToArray()))
            {
                ...
                message.From.Add(new MailboxAddress("Initial Infinity PrintSoft", "info@ibillcraft.com")); // set your email
                ...
                using (var client = new SmtpClient())
                {
                    ...
                    client.Authenticate("info@ibillcraft.com", "Apr@2024$"); // Your email address and password
                    client.Send(message);
