...
function submitpayment() {
    ...
    $.ajax({
        ...
        success: function (response) {
           ...
           // window.location.href = '/Purchase/Payment?pc_invoice_no=' + pc_invoice_no + '&pc_v_name=' + pc_v_name + '&pc_balance=' + pc_balance + '&pc_v_id=' + pc_v_id;
            window.location.href = '/Purchase/Payment?pc_invoice_no=' + response.pcp_invoice_no + '&pc_v_name=' + response.pcp_name + '&pc_balance=' + response.pcp_balance + '&pc_v_id=' + response.pcp_vendor_id + '&type=' + response.pcp_PaymentType + '&pc_id=' + response.pcp_invoice_id;
        },
        error: function (xhr, status, error) {
            // Handle errors
            // console.error(error);
