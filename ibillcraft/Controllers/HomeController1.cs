    ...
    public class ExampleFilter1Attribute : Attribute, IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            try
            {
                ...
                string comid = "D3DC5E98-1EE7-4F11-BB74-C9EDDD9FA22D";
                var controllerName = (string)context.RouteData.Values["controller"];
                //string roleid = httpContext.Session.GetString("RoleId");
                string roleid = "A3AB5C79-DED2-4261-8160-550F735763DE";

                //string baseaddress = httpContext.Session.GetString("BaseAddressUser");
                string baseaddress = "https://localhost:7119/api";
                var Home1 = new Home1();
                            



                string home = $"{baseaddress}/Home/GetAll?UserId={comid}&Server_Value={server}&controller={controllerName}&role={roleid}";
                string nurl = $"{baseaddress}/InvoiceNote/Get?UserId={comid}&Server_Value={server}&In_com_id={comid}&invoicename={controllerName}";
                string nurl1 = $"{baseaddress}/InvoiceNote/GetDate?UserId={comid}&Server_Value={server}";
