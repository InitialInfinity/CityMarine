    ...
    public class RoleMasterController : Controller
    {
        ...
        public IActionResult Index(string status)
        {
            try
            {
                ...
                HttpResponseMessage response = _httpClient.GetAsync($"{_httpClient.BaseAddress}/RoleMaster/GetAll?UserId={UserId}&status={status}&server={CUtility.serverValue}").Result;
        ...
        public IActionResult EditIndex()
        {
            try
            {
				...
				string url = $"{_httpClient.BaseAddress}/RoleMaster/GetMenu?UserId={UserId}&server={CUtility.serverValue}";
        ...
        public IActionResult Edit(Guid? r_id, string r_rolename, string r_description, string r_module, string r_isactive)
        {
			...
			try
			{
                ...
                string url = $"{_httpClient.BaseAddress}/RoleMaster/GetRoleById?r_id={r_id}&UserId={UserId}&server={CUtility.serverValue}";
                HttpResponseMessage response = _httpClient.GetAsync(url).Result;
                if (response.IsSuccessStatusCode)
                {
                    dynamic data = response.Content.ReadAsStringAsync().Result;
                    ...
                    string urlre = $"{_httpClient.BaseAddress}/RoleMaster/GetMenu?UserId={UserId}&server={CUtility.serverValue}";
